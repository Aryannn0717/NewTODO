...
function Dashboard() {
  ...
  const sortedAndFilteredTasks = () => {
    ...
    switch (sortBy) {
      case "priorityHigh":
        filtered.sort((a, b) => parseInt(b.priority) - parseInt(a.priority));
        break;
      case "priorityLow":
        filtered.sort((a, b) => parseInt(a.priority) - parseInt(b.priority));
        break;
        case "completed":
  ...
  return (
    <div className="p-4 max-w-lg mx-auto w-full dashboardContainer">
